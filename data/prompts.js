...
Rappel important : indique toujours clairement à ton audience que le lien est un lien d'affiliation (mention obligatoire en France : "lien affilié" ou équivalent), et ne recommande que des produits que tu utiliserais ou testerais réellement.`,
  ...
  },
  {
    ...
    category: "business",
    tags: ["Afrique", "business plan", "entrepreneuriat"],
    author: "Équipe PromptForums",
    upvotes: 0,
    comments: [],
  ...
  },
  {
    ...
    category: "business",
    tags: ["Afrique", "étude de marché", "validation"],
    author: "Équipe PromptForums",
    upvotes: 0,
    comments: [],
  ...
  },
  {
    ...
    category: "business",
    tags: ["Afrique", "stratégie commerciale", "ventes"],
    author: "Équipe PromptForums",
    upvotes: 0,
    comments: [],
  ...
  },
  {
    ...
    category: "emploi",
    tags: ["lettre de motivation", "candidature", "emploi"],
    author: "Équipe PromptForums",
    upvotes: 0,
    comments: [],
  ...
  },
  {
    ...
    category: "emploi",
    tags: ["entretien", "préparation", "emploi"],
    author: "Équipe PromptForums",
    upvotes: 0,
    comments: [],
